...
public class testMove : MonoBehaviour
{
    ...
    void MovementAndRotation()
    {
        ...
        Vector3 rightMovement = right * walkSpeed * Time.deltaTime * moveJoystick.Horizontal; // Getting right movement relative to camera
        Vector3 upMovement = fwd * walkSpeed * Time.deltaTime * moveJoystick.Vertical; // Getting up movement relative to camera
        ...
        if (lookToMovementDirection && heading != Vector3.zero)
        {
