...
public class DialogueScriptManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (script_1 != null) script_1.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_1.gameObject.name + " 출력");
        if (script_2 != null) script_2.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_2.gameObject.name + " 출력");
        if (script_3 != null) script_3.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_3.gameObject.name + " 출력");
        ...
        if (script_6 != null) script_6.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_6.gameObject.name + " 출력");
        if (script_7 != null) script_7.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_7.gameObject.name + " 출력");
        if (script_8 != null) script_8.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_8.gameObject.name + " 출력");
        if (script_9_1 != null) script_9_1.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_9_1.gameObject.name + " 출력");
        if (script_9_2 != null) script_9_2.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_9_2.gameObject.name + " 출력");
        if (script_9_3 != null) script_9_3.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_9_3.gameObject.name + " 출력");
        if (script_9_4 != null) script_9_4.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_9_4.gameObject.name + " 출력");
        if (script_10_1 != null) script_10_1.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_10_1.gameObject.name + " 출력");
        if (script_10_2 != null) script_10_2.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_10_2.gameObject.name + " 출력");
        if (script_10_3 != null) script_10_3.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_10_3.gameObject.name + " 출력");
        if (script_10_4 != null) script_10_4.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_10_4.gameObject.name + " 출력");
        if (script_13 != null) script_13.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_13.gameObject.name + " 출력");
        if (script_14 != null) script_14.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_14.gameObject.name + " 출력");
        if (script_15 != null) script_15.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_15.gameObject.name + " 출력");
        ...
        if (script_25 != null) script_25.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_25.gameObject.name + " 출력");
        if (script_26 != null) script_26.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_26.gameObject.name + " 출력");
        if (script_27 != null) script_27.OnActivated += () => UnityEngine.Debug.Log("[태웅 Dialogue] " + script_27.gameObject.name + " 출력");
    }
